...
class Encoder(nn.Module):
    def __init__(self, input_size, embedding_size, hidden_size, batch_size=8, n_layers=1):
        ...
        self.lstm1 = nn.LSTM(embedding_size, hidden_size, n_layers, batch_first=True, bidirectional=True)
        self.lstm2 = nn.LSTM(2*hidden_size, hidden_size, n_layers, batch_first=True, bidirectional=True)
